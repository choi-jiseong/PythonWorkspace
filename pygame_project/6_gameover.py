...
balls.append({
    ...
    "to_x" : 3, # x 축 이동방향, -3 이면 왼쪽, 3이면 오른쪽
    "to_y" : -6, # y 축 이동방향
        ...
        for weapon_idx, weapon_val in enumerate(weapons) :
            ...
            if weapon_rect.colliderect(ball_rect) :
                ...
                if ball_img_idx < 3 :
                    ...
                    #왼쪽으로 튕겨나가는 작은 공
                    balls.append({
                        "pos_x" : ball_pos_x + (ball_width / 2) - (small_ball_width / 2), # 즉 공의 x 좌표
                        "pos_y" : ball_pos_y + (ball_height / 2) - (small_ball_height / 2), # 즉 공의 y 좌표
            ...
            continue  # 안쪽 for 문 조건이 맞지 않으면 continu
        break
